...
class TelegramDocument implements TelegramMessageInterface
{
    use HasSharedParams;
    ...
    private bool $disableContentTypeDetection = false;
    ...
    public function disableContentTypeDetection(bool $disable = true): static
    {
